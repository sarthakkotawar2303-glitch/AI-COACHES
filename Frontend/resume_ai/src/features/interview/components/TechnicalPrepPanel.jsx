          ...
          return (
            <div
              ...
              className={`bg-zinc-900/30 border rounded-xl overflow-hidden transition-all duration-200 ${
                isOpen ? "border-purple-500/60 shadow-lg shadow-purple-500/5 bg-zinc-900/40" : "border-zinc-800 hover:border-zinc-700"
              }`}
            >
              <div
              ...
              >
                <div className="flex gap-3 items-start pr-2 text-left">
                  <span className="text-[10px] font-bold tracking-wider text-purple-400 bg-purple-500/10 px-2 py-1 border border-purple-500/15 rounded font-mono shrink-0">
                    Q{idx + 1}
                  </span>
              ...
              {isOpen && (
                <div className="p-5 border-t border-zinc-850/60 space-y-4 text-xs sm:text-sm leading-relaxed bg-zinc-950/40 text-left">
                  <div className="p-3.5 bg-purple-500/5 border-l-2 border-purple-500 rounded-r-lg">
