          ...
          {[...plan]
            ...
            .map((step, idx) => (
              <div key={idx} className="relative">
                {/* Timeline Bullet Dot */}
                <span className="absolute -left-[26px] top-2.5 w-3 h-3 rounded-full bg-zinc-950 border-2 border-purple-500 shadow-lg shadow-purple-500/40 animate-pulse"></span>
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-4 space-y-1 hover:border-zinc-700 transition-colors shadow-md">
                  <span className="text-[9px] font-bold text-purple-400 tracking-wider uppercase font-mono bg-purple-500/10 px-2 py-0.5 border border-purple-500/10 rounded">
                    Day {step.day}
                  </span>
